...
asr_pheno_obj <- asr(df = df,tr = tr,tip_name_variable = tip_name_variable ,trait = pheno,model="ER",node_states = "joint",conf_threshold=NULL)
asr_geno_obj <- asr(df = df,tr = tr,tip_name_variable = tip_name_variable ,trait = pheno,model="ER",node_states = "joint",conf_threshold=NULL)
