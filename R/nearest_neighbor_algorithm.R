...
#' @param tip_name_variable Name of variable containing tip names. Must be found in the metadata, dataframe. Tip name entries must also correspond to tip names in the tree
#' @param phylogenetic_distance Matrix of phylogenetic distance. Generated by ape::cophenetic.phylo(tree)
#' @param variant_distance (OPTIONAL) Matrix with secondary distance measure, presumably SNPs. If not specified, the first entry will be gathered
...
#' @param comparison Boolean (TRUE/FALSE) indicating whether to restrict analysis to isolates with/without a trait (comparison_feature)
#' @param comparison_feature Name of variable to compare
#' @return Dataframe with the nearest neighbor of interest.
