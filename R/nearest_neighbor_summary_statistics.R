...
nearest_neighbor_summary_statistics <- function(nn_diff_df, cat_vars = NULL, binary_vars = NULL, cont_vars = NULL, log_2 = FALSE) {
  n <- nrow(nn_diff_df)
  ...
  binary_vars_2 <- paste0(binary_vars, "_binary_diff")
  binary_sum_df <- lapply(binary_vars_2, FUN = function(x) {
  ...
  if (log_2 == TRUE) {
    cont_vars2_2 <- c(paste0(cont_vars, "_diff"), paste0(cont_vars, "_log_2_diff"))
