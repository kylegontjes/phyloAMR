...
#' @export
paint_tree_with_states <- function(parent_child_df,tr,scale_labels = c("Present","Absent"),legend_name = "Trait"){
  edge_color <-  scale_color_manual(breaks=c(1,0),values=c("red","black"),labels=scale_labels,name=legend_name)
