---
title: "Ancestral state reconstruction of a trait"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Ancestral state reconstruction of a trait}
...
```{r,fig.width=7.5,fig.height=7.5}
ggtree::gheatmap(painted_tree,df %>% as.data.frame %>%select(colistin_ns) %>% mutate_all(as.factor),colnames_position = 'top',width = .25,low = 'white',high='black',colnames_angle = 90,legend_title = 'Colistin non-susceptibility',hjust = 0,color = NULL) + ylim(NA,485) + feature_scale
```
