...
ggtree::gheatmap(ggtree(tr),asr_cluster_obj %>% select(asr_cluster_renamed) %>% mutate_all(as.factor) %>% as.data.frame,colnames_position = 'top',width = .25,colnames_angle = 90,legend_title = 'Colistin non-usceptibility',hjust = 0,offset=0.0000075,color=NULL) + ylim(NA,500) + cluster_scale
```
